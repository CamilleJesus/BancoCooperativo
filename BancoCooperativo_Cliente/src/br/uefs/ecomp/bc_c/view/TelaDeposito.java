...
/**
 * Classe (Java Principal) TelaDeposito, responsável pelo deposito realizado pelo
 * cliente no sistema Banco Cooperativo.
 * 
 * @author Camille Jesus
 */
public class TelaDeposito extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("TelaDeposito.fxml"));        
