...
/**
 * Classe (Java Principal) TelaTitular, responsável pela adição de titular realizada
 * pelo cliente no sistema Banco Cooperativo.
 * 
 * @author Camille Jesus
 */
public class TelaTitular extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("TelaTitular.fxml"));        
